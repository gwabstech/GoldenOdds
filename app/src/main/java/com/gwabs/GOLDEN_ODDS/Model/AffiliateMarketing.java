...
public class AffiliateMarketing {
   ...
   private final String OneXbetmessage = "Register and Stake with 1XBET to enjoy Highest odds with 200% welcome bonus. \nDont forget to copy and use GOLDENODDS as promo code to enjoy 300% first deposit bonus.";

   private final String OnexbetTitle = "STAKE WITH 1XBET";

   private final String OnexbetAfLink = "https://refpa.top/L?tag=d_1101243m_14987c_GoldenOddsApp&site=1101243&ad=14987&r=registration/";
   ...
   public String getOneXbetmessage() {
      return OneXbetmessage;
   }

   public String getOnexbetTitle() {
      return OnexbetTitle;
   }

   public String getOnexbetAfLink() {
